...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240313005557_FullDatabase")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 21, 55, 56, 555, DateTimeKind.Unspecified).AddTicks(2233), new TimeSpan(0, -3, 0, 0, 0)));
